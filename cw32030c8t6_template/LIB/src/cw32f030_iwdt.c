 ...
 * @brief 喂狗
 */
void __inline IWDT_Refresh(void)
{
    __IWDT_REFRESH();
}
 ...
 * @brief 寄存器保护解锁
 */
void __inline IWDT_Unlock(void)
{
    __IWDT_UNLOCK();
}
 ...
 * @brief 清除IWDT的溢出标志OV
 */
void __inline IWDT_ClearOVFlag(void)
{
    CW_IWDT->SR_f.OV = 0;
}
